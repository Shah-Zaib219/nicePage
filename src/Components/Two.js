  ...
  return (
    <div className='three'>
      <div className='subthree1'>
        ...
        <p>
If price is the most important factor in your search, comparing car insurance quotes can help you find the cheapest rate. But your shopping experience will also shed light on a company’s customer service standards.</p>
      </div>
      <div className='subthree2'>
        <h3>To find the top car insurance companies:</h3>
        <ol>
